...
const ProductDetails = () => {
    ...
    useEffect(() => {
        const fetchProduct = async () => {
            try {
                const response = await axiosInstance.get(`/sellerProductUpload/getProduct/${id}`);
    ...
    return (
        <div className="p-8 min-h-screen flex items-center justify-center ">
            <div className="rounded-xl shadow-md shadow-black border border-gray-500 flex flex-col lg:flex-row w-full max-w-6xl overflow-hidden">
                {/* Product Image */}
                ...
                <div className=" lg:w-1/2 m-6">
                    ...
                    <div className="flex">
                        ...
                        >
                            ...
                            <option value="DOT KNIT (MESH FABRIC)">DOT KNIT (MESH FABRIC)</option>
